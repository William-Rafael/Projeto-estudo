...
public class FileStorageService {
	...
	//contrutor - com injencao de depedencia(sempre no metodo contrutor)
	@Autowired
	...
	public String storeFile(MultipartFile file) {
		...
		//bloco try/catch para verificar se o arquivo nao contem caracteres invalidos
		try {
			...
			//"copiar" o arquivo para o local indicado (caso exista um arquivo com mesmo nome, sera substituido)
