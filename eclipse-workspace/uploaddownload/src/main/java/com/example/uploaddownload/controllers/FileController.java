...
public class FileController {
	...
	//criar uma propriedade para servir de log de manipulaçao a partir do controller
	...
	//criar a estrutura logica que possibilitara o download de arquivos
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request){
		...
		//verificar se o tipo de conteudo não pode ser verificado porque a variavael nao conseguiu acessa-lo
		if(contentType == null) {
